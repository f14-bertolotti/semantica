...
data/xor-transformer-ndh/%/modellast.pt data/xor-transformer-ndh/%/input_cdists.npy data/xor-transformer-ndh/%/output_cdists.npy data/xor-transformer-ndh/%/valid_epoch.log:
	mkdir -p $(dir $@)
	cp $(shell dirname $(realpath $(firstword $(MAKEFILE_LIST))))/MakefileTransformerSmallNDH.mk $(dir $@)makefile
	PYTHONPATH=:.:semeqv \
...
data/xor-transformer-ndh/embeddings_wt.pdf: \
	data/xor-transformer-ndh/42-transformerwt/input_cdists.npy \
	data/xor-transformer-ndh/43-transformerwt/input_cdists.npy \
	data/xor-transformer-ndh/44-transformerwt/input_cdists.npy \
...
data/xor-transformer-ndh/input_embeddings.pdf: \
	data/xor-transformer-ndh/42-transformer/input_cdists.npy \
	data/xor-transformer-ndh/43-transformer/input_cdists.npy \
	data/xor-transformer-ndh/44-transformer/input_cdists.npy \
...
data/xor-transformer-ndh/output_embeddings.pdf: \
	data/xor-transformer-ndh/42-transformer/output_cdists.npy \
	data/xor-transformer-ndh/43-transformer/output_cdists.npy \
	data/xor-transformer-ndh/44-transformer/output_cdists.npy \
...
data/xor-transformer-ndh/accuracies.pdf: \
	data/xor-transformer-ndh/42-transformer/valid_epoch.log \
	data/xor-transformer-ndh/42-transformerwt/valid_epoch.log \
	data/xor-transformer-ndh/43-transformer/valid_epoch.log \
	data/xor-transformer-ndh/43-transformerwt/valid_epoch.log \
	data/xor-transformer-ndh/44-transformer/valid_epoch.log \
	data/xor-transformer-ndh/44-transformerwt/valid_epoch.log \
	data/xor-transformer-ndh/45-transformer/valid_epoch.log \
	data/xor-transformer-ndh/45-transformerwt/valid_epoch.log \
	data/xor-transformer-ndh/46-transformer/valid_epoch.log \
	data/xor-transformer-ndh/46-transformerwt/valid_epoch.log

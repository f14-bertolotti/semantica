...
data/xor-lstm-medium/%/modellast.pt data/xor-lstm-medium/%/input_cdists.npy data/xor-lstm-medium/%/output_cdists.npy data/xor-lstm-medium/%/valid_epoch.log:
	mkdir -p $(dir $@)
	cp $(shell dirname $(realpath $(firstword $(MAKEFILE_LIST))))/MakefileLSTMMedium.mk $(dir $@)makefile
	PYTHONPATH=:.:semeqv \
...
data/xor-lstm-medium/embeddings_wt.pdf: \
	data/xor-lstm-medium/42-lstmwt/input_cdists.npy \
	data/xor-lstm-medium/43-lstmwt/input_cdists.npy \
	data/xor-lstm-medium/44-lstmwt/input_cdists.npy \
...
data/xor-lstm-medium/input_embeddings.pdf: \
	data/xor-lstm-medium/42-lstm/input_cdists.npy \
	data/xor-lstm-medium/43-lstm/input_cdists.npy \
	data/xor-lstm-medium/44-lstm/input_cdists.npy \
...
data/xor-lstm-medium/output_embeddings.pdf: \
	data/xor-lstm-medium/42-lstm/output_cdists.npy \
	data/xor-lstm-medium/43-lstm/output_cdists.npy \
	data/xor-lstm-medium/44-lstm/output_cdists.npy \
...
data/xor-lstm-medium/accuracies.pdf: \
	data/xor-lstm-medium/42-lstm/valid_epoch.log \
	data/xor-lstm-medium/42-lstmwt/valid_epoch.log \
	data/xor-lstm-medium/43-lstm/valid_epoch.log \
	data/xor-lstm-medium/43-lstmwt/valid_epoch.log \
	data/xor-lstm-medium/44-lstm/valid_epoch.log \
	data/xor-lstm-medium/44-lstmwt/valid_epoch.log \
	data/xor-lstm-medium/45-lstm/valid_epoch.log \
	data/xor-lstm-medium/45-lstmwt/valid_epoch.log \
	data/xor-lstm-medium/46-lstm/valid_epoch.log \
	data/xor-lstm-medium/46-lstmwt/valid_epoch.log
